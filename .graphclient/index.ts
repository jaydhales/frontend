...
export type Vault_filter = {
  ...
  collateralSymbol_not_starts_with_nocase?: InputMaybe<
  ...
  collateralSymbol_not_ends_with_nocase?: InputMaybe<
    Scalars["String"]["input"]
  >;
...
> = ResolversObject<{
  vault?: Resolver<
    Maybe<ResolversTypes["Vault"]>,
    ParentType,
    ContextType,
    RequireFields<QueryvaultArgs, "id" | "subgraphError">
  >;
  vaults?: Resolver<
    Array<ResolversTypes["Vault"]>,
    ParentType,
    ContextType,
    RequireFields<QueryvaultsArgs, "skip" | "first" | "subgraphError">
  >;
  _meta?: Resolver<
...
> = ResolversObject<{
  vault?: SubscriptionResolver<
    Maybe<ResolversTypes["Vault"]>,
    "vault",
    ParentType,
    ContextType,
    RequireFields<SubscriptionvaultArgs, "id" | "subgraphError">
  >;
  vaults?: SubscriptionResolver<
    Array<ResolversTypes["Vault"]>,
    "vaults",
    ParentType,
    ContextType,
    RequireFields<SubscriptionvaultsArgs, "skip" | "first" | "subgraphError">
  >;
...
> = ResolversObject<{
  ...
  vaultId?: Resolver<ResolversTypes["BigInt"], ParentType, ContextType>;
...
export async function getMeshOptions(): Promise<GetMeshOptions> {
  ...
  const sirTradeIndexHandler = new GraphqlHandler({
    ...
    config: {
      endpoint: "http://140.82.62.189:8000/subgraphs/name/sir-trade/index",
    },
    baseDir,
    cache,
    pubsub,
  ...
  const documentHashMap = {
    ee8eda4a405bbdf14e06bb947ee66345656d29f6bd37eae34e7056f9aa808354:
      VaultsDocument,
  };
...
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    vaults(
      ...
      return requester<vaultsQuery, vaultsQueryVariables>(
        vaultsDocument,
        variables,
        options,
      ) as Promise<vaultsQuery>;
    },
  };
}
